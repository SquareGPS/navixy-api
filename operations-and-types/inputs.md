...
| `customFields`       | [\[CustomFieldFilter!\]](inputs.md#customfieldfilter) | Filter by custom field values.                                      |
...
| Field             | Type                                          | Description                                                                |
| ----------------- | --------------------------------------------- | -------------------------------------------------------------------------- |
| `field`           | [DeviceOrderField](enums.md#deviceorderfield) | The standard field to order by. Mutually exclusive with `customFieldCode`. |
| `customFieldCode` | [Code](scalars.md#code)                       | The custom field code to order by. Mutually exclusive with `field`.        |
| `direction`       | [OrderDirection!](enums.md#orderdirection)    | The direction to order.                                                    |
...
| `vendorIds`     | `[ID!]`                 | Filter by vendors (OR within field).                              |
| `titleContains` | `String`                | Partial match on title (case-insensitive contains). Auto-trimmed. |
| `code`          | [Code](scalars.md#code) | Exact code match.                                                 |
...
| `identifiers`    | [\[DeviceIdentifierInput!\]](inputs.md#deviceidentifierinput) | The hardware identifiers.                  |
| `customFields`   | [CustomFieldsPatchInput](inputs.md#customfieldspatchinput)    | The custom field values.                   |
...
| `customFields` | [CustomFieldsPatchInput](inputs.md#customfieldspatchinput) | The custom field changes.                   |
...
| `namespace` | [Code](scalars.md#code)                | The namespace for uniqueness scope. Null means globally unique. |
...
| `identifier` | [DeviceIdentifierInput!](inputs.md#deviceidentifierinput) | The identifier details. |
...
| `code`           | [Code!](scalars.md#code)                               | —       | The machine-readable code.               |
| `title`          | `String!`                                              | —       | The display name. Auto-trimmed.          |
| `order`          | `Int`                                                  | `0`     | The display order.                       |
| `meta`           | [CatalogItemMetaInput](inputs.md#catalogitemmetainput) | —       | The display properties.                  |
...
| Field             | Type                                        | Description                                                                |
| ----------------- | ------------------------------------------- | -------------------------------------------------------------------------- |
| `field`           | [AssetOrderField](enums.md#assetorderfield) | The standard field to order by. Mutually exclusive with `customFieldCode`. |
| `customFieldCode` | [Code](scalars.md#code)                     | The custom field code to order by. Mutually exclusive with `field`.        |
| `direction`       | [OrderDirection!](enums.md#orderdirection)  | The direction to order.                                                    |
...
| Field       | Type                                                   | Description             |
| ----------- | ------------------------------------------------------ | ----------------------- |
| `field`     | [AssetGroupOrderField!](enums.md#assetgrouporderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)             | The direction to order. |
...
| Field       | Type                                                           | Description             |
| ----------- | -------------------------------------------------------------- | ----------------------- |
| `field`     | [AssetGroupItemOrderField!](enums.md#assetgroupitemorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)                     | The direction to order. |
...
| `color`          | [HexColorCode](scalars.md#hexcolorcode) | The color for UI display.                 |
...
| `version` | `Int!`                                  | The current version for optimistic locking. |
| `title`   | `String`                                | The new display name. Auto-trimmed.         |
| `color`   | [HexColorCode](scalars.md#hexcolorcode) | The new color.                              |
...
| `title`             | `String!`                                                                     | —       | The display name. Auto-trimmed.               |
| `order`             | `Int`                                                                         | `0`     | The display order.                            |
| `allowedAssetTypes` | [\[AssetGroupTypeConstraintInput!\]](inputs.md#assetgrouptypeconstraintinput) | —       | The allowed asset types with optional limits. |
| `meta`              | [CatalogItemMetaInput](inputs.md#catalogitemmetainput)                        | —       | The display properties.                       |
...
| `title`             | `String`                                                                      | The new display name. Auto-trimmed.                |
| `order`             | `Int`                                                                         | The new display order.                             |
| `allowedAssetTypes` | [\[AssetGroupTypeConstraintInput!\]](inputs.md#assetgrouptypeconstraintinput) | Replace allowed asset types. Null means no change. |
| `meta`              | [CatalogItemMetaInput](inputs.md#catalogitemmetainput)                        | The display properties.                            |
...
| Field             | Type                                                | Description                                                                |
| ----------------- | --------------------------------------------------- | -------------------------------------------------------------------------- |
| `field`           | [GeoObjectOrderField](enums.md#geoobjectorderfield) | The standard field to order by. Mutually exclusive with `customFieldCode`. |
| `customFieldCode` | [Code](scalars.md#code)                             | The custom field code to order by. Mutually exclusive with `field`.        |
| `direction`       | [OrderDirection!](enums.md#orderdirection)          | The direction to order.                                                    |
...
| `geometry`       | [GeoJSON!](scalars.md#geojson)                             | The [GeoJSON](https://geojson.org/) geometry.  |
| `customFields`   | [CustomFieldsPatchInput](inputs.md#customfieldspatchinput) | The custom field values.                       |
...
| `version`      | `Int!`                                                     | The current version for optimistic locking. |
| `title`        | `String`                                                   | The new display name. Auto-trimmed.         |
| `geometry`     | [GeoJSON](scalars.md#geojson)                              | The new geometry.                           |
| `customFields` | [CustomFieldsPatchInput](inputs.md#customfieldspatchinput) | The custom field changes.                   |
...
| Field             | Type                                              | Description                                                                |
| ----------------- | ------------------------------------------------- | -------------------------------------------------------------------------- |
| `field`           | [ScheduleOrderField](enums.md#scheduleorderfield) | The standard field to order by. Mutually exclusive with `customFieldCode`. |
| `customFieldCode` | [Code](scalars.md#code)                           | The custom field code to order by. Mutually exclusive with `field`.        |
| `direction`       | [OrderDirection!](enums.md#orderdirection)        | The direction to order.                                                    |
...
| `scheduleData`   | [ScheduleData!](scalars.md#scheduledata)                   | The schedule data.                           |
| `customFields`   | [CustomFieldsPatchInput](inputs.md#customfieldspatchinput) | The custom field values.                     |
...
| `version`      | `Int!`                                                     | The current version for optimistic locking. |
| `title`        | `String`                                                   | The new display name. Auto-trimmed.         |
| `scheduleData` | [ScheduleData](scalars.md#scheduledata)                    | The new schedule data.                      |
| `customFields` | [CustomFieldsPatchInput](inputs.md#customfieldspatchinput) | The custom field changes.                   |
...
| Field       | Type                                                                             | Description             |
| ----------- | -------------------------------------------------------------------------------- | ----------------------- |
| `field`     | [DeviceInventoryRelationOrderField!](enums.md#deviceinventoryrelationorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)                                       | The direction to order. |
...
| Field       | Type                                                 | Description             |
| ----------- | ---------------------------------------------------- | ----------------------- |
| `field`     | [InventoryOrderField!](enums.md#inventoryorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)           | The direction to order. |
...
| Field       | Type                                                       | Description             |
| ----------- | ---------------------------------------------------------- | ----------------------- |
| `field`     | [OrganizationOrderField!](enums.md#organizationorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)                 | The direction to order. |
...
| `features`   | [\[OrganizationFeature!\]](enums.md#organizationfeature) | `[]`    | The feature flags to enable.                             |
...
| `features`   | [\[OrganizationFeature!\]](enums.md#organizationfeature) | The new feature flags.                      |
...
| Field       | Type                                           | Description             |
| ----------- | ---------------------------------------------- | ----------------------- |
| `field`     | [MemberOrderField!](enums.md#memberorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)     | The direction to order. |
...
| `customFields`   | [CustomFieldsPatchInput](inputs.md#customfieldspatchinput) | The membership-specific custom fields. |
...
| Field       | Type                                                     | Description             |
| ----------- | -------------------------------------------------------- | ----------------------- |
| `field`     | [IntegrationOrderField!](enums.md#integrationorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)               | The direction to order. |
...
| Field       | Type                                                 | Description             |
| ----------- | ---------------------------------------------------- | ----------------------- |
| `field`     | [ActorRoleOrderField!](enums.md#actorroleorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)           | The direction to order. |
...
| Field       | Type                                                           | Description             |
| ----------- | -------------------------------------------------------------- | ----------------------- |
| `field`     | [RolePermissionOrderField!](enums.md#rolepermissionorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)                     | The direction to order. |
...
| Field       | Type                                                 | Description             |
| ----------- | ---------------------------------------------------- | ----------------------- |
| `field`     | [UserScopeOrderField!](enums.md#userscopeorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)           | The direction to order. |
...
| `expireDate` | [DateTime](scalars.md#datetime) | The expiration date. Null means the role is permanent. |
...
| `actions`           | [\[ActionPermission!\]!](enums.md#actionpermission) | The actions to allow.                                        |
...
| Field      | Type                                     | Description                                                                   |
| ---------- | ---------------------------------------- | ----------------------------------------------------------------------------- |
| `code`     | [Code!](scalars.md#code)                 | The custom field code to filter by.                                           |
| `operator` | [FieldOperator!](enums.md#fieldoperator) | The comparison operator.                                                      |
| `value`    | [JSON](scalars.md#json)                  | The value to compare against. Null for `IS_NULL` and `IS_NOT_NULL` operators. |
...
| Field   | Type                         | Description                                 |
| ------- | ---------------------------- | ------------------------------------------- |
| `set`   | [JSON](scalars.md#json)      | Fields to set or update as a key-value map. |
| `unset` | [\[Code!\]](scalars.md#code) | Field codes to remove.                      |
...
| `fieldType`          | [FieldType!](enums.md#fieldtype)                | —       | The data type. Immutable after creation.                                  |
| `order`              | `Int`                                           | `0`     | The display order.                                                        |
| `params`             | [FieldParamsInput!](inputs.md#fieldparamsinput) | —       | The type-specific parameters. Exactly one variant must be provided.       |
...
| `order`       | `Int`                                          | The new display order.                                                             |
| `params`      | [FieldParamsInput](inputs.md#fieldparamsinput) | The updated parameters. Only `isRequired` and type-specific fields can be changed. |
...
| Field       | Type                                                             | Description                          |
| ----------- | ---------------------------------------------------------------- | ------------------------------------ |
| `string`    | [StringFieldParamsInput](inputs.md#stringfieldparamsinput)       | Parameters for STRING field type.    |
| `text`      | [TextFieldParamsInput](inputs.md#textfieldparamsinput)           | Parameters for TEXT field type.      |
| `number`    | [NumberFieldParamsInput](inputs.md#numberfieldparamsinput)       | Parameters for NUMBER field type.    |
| `boolean`   | [BooleanFieldParamsInput](inputs.md#booleanfieldparamsinput)     | Parameters for BOOLEAN field type.   |
| `date`      | [DateFieldParamsInput](inputs.md#datefieldparamsinput)           | Parameters for DATE field type.      |
| `datetime`  | [DateTimeFieldParamsInput](inputs.md#datetimefieldparamsinput)   | Parameters for DATETIME field type.  |
| `geojson`   | [GeoJsonFieldParamsInput](inputs.md#geojsonfieldparamsinput)     | Parameters for GEOJSON field type.   |
| `schedule`  | [ScheduleFieldParamsInput](inputs.md#schedulefieldparamsinput)   | Parameters for SCHEDULE field type.  |
| `options`   | [OptionsFieldParamsInput](inputs.md#optionsfieldparamsinput)     | Parameters for OPTIONS field type.   |
| `device`    | [DeviceFieldParamsInput](inputs.md#devicefieldparamsinput)       | Parameters for DEVICE field type.    |
| `reference` | [ReferenceFieldParamsInput](inputs.md#referencefieldparamsinput) | Parameters for REFERENCE field type. |
| `catalog`   | [CatalogFieldParamsInput](inputs.md#catalogfieldparamsinput)     | Parameters for CATALOG field type.   |
| `tag`       | [TagFieldParamsInput](inputs.md#tagfieldparamsinput)             | Parameters for TAG field type.       |
...
| `options`      | [\[FieldOptionInput!\]!](inputs.md#fieldoptioninput) | —       | The available options.                    |
...
| Field         | Type                     | Default | Description                      |
| ------------- | ------------------------ | ------- | -------------------------------- |
| `code`        | [Code!](scalars.md#code) | —       | The unique code.                 |
...
| --------------- | ---------------------------- | ----------------------------------------------------------------- |
| `titleContains` | `String`                     | Partial match on title (case-insensitive contains). Auto-trimmed. |
| `codes`         | [\[Code!\]](scalars.md#code) | Match any of these codes.                                         |
...
| Field       | Type                                                     | Description             |
| ----------- | -------------------------------------------------------- | ----------------------- |
| `field`     | [CatalogItemOrderField!](enums.md#catalogitemorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)               | The direction to order. |
...
| ---------------- | ---------------------------------------------- | -------------------------------------------------- |
| `actorIds`       | `[ID!]`                                        | Filter by actors (OR within field).                |
| `aggregateTypes` | [\[Code!\]](scalars.md#code)                   | Filter by entity types (OR within field).          |
| `aggregateIds`   | `[ID!]`                                        | Filter by specific entity IDs (OR within field).   |
| `eventTypes`     | [\[AuditEventType!\]](enums.md#auditeventtype) | Filter by event types (OR within field).           |
| `sourceTypes`    | [\[SourceType!\]](enums.md#sourcetype)         | Filter by source types (OR within field).          |
| `traceId`        | `String`                                       | Filter by trace ID.                                |
| `from`           | [DateTime](scalars.md#datetime)                | Return events that occurred after this timestamp.  |
| `to`             | [DateTime](scalars.md#datetime)                | Return events that occurred before this timestamp. |
...
| Field       | Type                                                   | Description             |
| ----------- | ------------------------------------------------------ | ----------------------- |
| `field`     | [AuditEventOrderField!](enums.md#auditeventorderfield) | The field to order by.  |
| `direction` | [OrderDirection!](enums.md#orderdirection)             | The direction to order. |
...
| `code`           | [Code!](scalars.md#code)                               | —       | The machine-readable code, unique within the catalog and organization. |
| `title`          | `String!`                                              | —       | The display name. Auto-trimmed.                                        |
| `order`          | `Int`                                                  | `0`     | The display order.                                                     |
...
| Field      | Type                               | Description                                     |
| ---------- | ---------------------------------- | ----------------------------------------------- |
| `lat`      | [Latitude!](scalars.md#latitude)   | The latitude coordinate (-90 to 90 degrees).    |
| `lng`      | [Longitude!](scalars.md#longitude) | The longitude coordinate (-180 to 180 degrees). |
...
| Field  | Type                                          | Description                     |
| ------ | --------------------------------------------- | ------------------------------- |
| `name` | [PersonNameInput!](inputs.md#personnameinput) | The structured name components. |
