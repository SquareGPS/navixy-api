...
| `asset` | [Asset](../assets.md#asset)! | The asset in the group. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| `input` | [CatalogItemDeleteInput](../catalogs/README.md#catalogitemdeleteinput)! | The input fields for deleting the asset group type. |
