...
| tariff\_id    | An ID of new tariff (must belong to current dealer). | int  |
| bonus\_amount | A new bonus amount.                                  | int  |
| free\_days    | A new free period.                                   | int  |
...
| order\_by | Optional. Specify list ordering. Can be one of "code", "activated", "tariff\_id", "tariff\_name", "device\_type", "money\_amount", "bonus\_amount", "free\_days". | string  |
...
* `list` - array of objects. List of [activation code objects](activation_code.md#activation-code-object).
...
| tariff\_id    | An ID of a new tariff. Have to belong to a current dealer. | int          |
| bonus\_amount | A new bonus.                                               | int          |
| free\_days    | A new free period.                                         | int          |
