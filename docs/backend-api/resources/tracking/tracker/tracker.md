...
```abap
$ curl -X POST 'https://api.navixy.com/v2/fsm/fsm/tracker/change_phone' \
...
```abap
$ curl -X POST 'https://api.navixy.com/v2/fsm/fsm/tracker/corrupt' \
-H 'Content-Type: application/json' \ 
...
```abap
$ curl -X POST 'https://api.navixy.com/v2/fsm/fsm/tracker/delete' \
-H 'Content-Type: application/json' \ 
-d '{"tracker_id": "999119", "hash": "a6aa75587e5c59c32d347da438505fc3"}'
```
...
```abap
$ curl -X POST 'https://api.navixy.com/v2/fsm/fsm/tracker/get_diagnostics' \
-H 'Content-Type: application/json' \ 
-d '{"tracker_id": "999119", "hash": "a6aa75587e5c59c32d347da438505fc3"}'
```
...
```abap
$ curl -X POST 'https://api.navixy.com/v2/fsm/fsm/tracker/get_fuel' \
-H 'Content-Type: application/json' \ 
-d '{"tracker_id": "999119", "hash": "a6aa75587e5c59c32d347da438505fc3"}'
```
...
```abap
$ curl -X POST 'https://api.navixy.com/v2/fsm/fsm/tracker/get_inputs' \
-H 'Content-Type: application/json' \ 
-d '{"tracker_id": "999119", "hash": "a6aa75587e5c59c32d347da438505fc3"}'
```
...
```abap
$ curl -X POST 'https://api.navixy.com/v2/fsm/fsm/tracker/get_last_gps_point' \
-H 'Content-Type: application/json' \ 
-d '{"tracker_id": "999119", "hash": "a6aa75587e5c59c32d347da438505fc3"}'
```
...
```abap
$ curl -X POST 'https://api.navixy.com/v2/fsm/fsm/tracker/get_readings' \
-H 'Content-Type: application/json' \ 
-d '{"tracker_id": "999119", "hash": "a6aa75587e5c59c32d347da438505fc3"}'
```
