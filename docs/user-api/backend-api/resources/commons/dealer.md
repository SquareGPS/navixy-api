...
* `settings` - object. Custom settings.
  ...
  * `locale` - [enum](../../#data-types). Default locale of the dealer.
  ...
  * `type` - [enum](../../#data-types). Default map type.
  * `location` - object. Default map center location.
  * `lat` - float. Latitude.
  * `long` - float. Longitude.
  * `zoom` - int. Default map zoom level.
  * `currency` - [enum](../../#data-types). Dealer's currency ISO 4217 code.
  ...
  * `geocoder` - [enum](../../#data-types). Default geocoder.
  * `route_provider` - [enum](../../#data-types). Default router.
  * `measurement_system` - [enum](../../#data-types). Measurement system.
  * `display_model_features_link` - boolean. When `true` show in model info link to squaregps.com (UI option).
  * `color_theme` - [enum](../../#data-types). Color theme code or empty string (for default theme).
  * `app_color_theme` - [enum](../../#data-types). Mobile app color theme code or empty string (for default theme).
...
* `platform` - key-value object. Global platform settings.
  * `iso_datetime_support` - boolean, if `true` platform supports ISO 8601 [date/time format](../../#datetime-formats).
