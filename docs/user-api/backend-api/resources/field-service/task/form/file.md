...
{% code overflow="wrap" %}
```sh
curl -X POST 'https://api.eu.navixy.com/v2/task/form/file/create' \
...
{% code overflow="wrap" %}
```http
https://api.eu.navixy.com/v2/task/form/file/create?hash=a6aa75587e5c59c32d347da438505fc3&task_id=11231&field_id=file1&size=10
```
{% endcode %}
{% endtab %}
{% endtabs %}
