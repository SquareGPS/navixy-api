...
For a comprehensive list of supported sensors, refer to the [input\_name documentation](../../resources/tracker/sensor/input_name.md).
...
3. **Calibrate the Sensor:** If necessary, [calibrate the sensor](../../resources/tracker/sensor/calibration_data.md) (for analog sensors or those sending uncalibrated values) to ensure accurate data readings.
