...
* `date/time` and `local_time` types described at\
  the [data types description section](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types).
...
| type             | One of pre-defined types of rules. See [rule types](rule_types.md).                                                                                                                                              | [enum](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types) |
