...
2. Get the hash of an [API Key](../commons/user-authentication/api-keys.md).
...
> **Notes:**
>
> * The [subscription requests](subscription.md) must contain the `hash` of an [API Key](../commons/user-authentication/api-keys.md).
