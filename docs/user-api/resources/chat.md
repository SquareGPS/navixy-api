...
| from        | Optional. Start date/time of searching. Default value is now minus 7 days.                       | [date/time](/broken/pages/ZecFmxN0cywjosU1jKcD#datetime-formats) | `yyyy-MM-dd HH:mm:ss` |
| to          | Optional. End date/time for searching. Default value is now.                                     | [date/time](/broken/pages/ZecFmxN0cywjosU1jKcD#datetime-formats) | `yyyy-MM-dd HH:mm:ss` |
