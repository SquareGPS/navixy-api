...
* `sleep_mode` - [enum](broken-reference). Can be "disabled" | "engine" | "asset" | "hybrid".
...
* `mode` - [enum](broken-reference). Device's working mode. Can be "DAILY" | "TEST" | "SEARCH", default="DAILY".
