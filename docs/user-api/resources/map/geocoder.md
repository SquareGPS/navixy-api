...
| geocoder      | Optional. Geocoder type that will be preferably used for searching. Google geocoder is always used for users with the premium GIS.                                                                                                                                                                           | [enum](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types) | "google"                                                          |
...
| lang          | Optional. Language in which results should be. ISO 639 [language code](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types).                                                                                                                                                                                       | [enum](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types) | "en\_US"                                                          |
...
| name          | description                                                                                                                                     | type                                                  | format               |
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | -------------------- |
| location      | Location coordinates (see: [data types description section](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types) section).                            | location                                              | `{"lat": , "lng": }` |
| geocoder      | Optional. Geocoder type that will be preferably used for searching. Google geocoder is always used for users with the premium GIS.              | [enum](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types) | "google"             |
| lang          | Optional. ISO 639 [language code](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types).                                                               | [enum](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types) | "en\_US"             |
| with\_details | Optional. If `true` then the response will contain details.                                                                                     | boolean                                               | `true`               |
| goal          | Helps to choose the target geocoder. Now supported `ui`, `ui_user_action`. Use `ui_user_action` for requests initiated by user, otherwise `ui`. | [enum](/broken/pages/ZecFmxN0cywjosU1jKcD#data-types) | "ui"                 |
