...
When submitting form values of type [file](broken-reference), [photo](broken-reference) or[signature](broken-reference), you need to provide file ID. To obtain it, first you [create](file.md#create)\
