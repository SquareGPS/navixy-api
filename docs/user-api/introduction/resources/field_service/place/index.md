...
If there's an [employee](../../../../backend-api/resources/field_service/employee/) [assigned](../../tracking/tracker/employee.md#assign) to a Mobile Tracker App ([Android](https://play.google.com/store/apps/details?id=com.navixy.xgps.tracker\&hl=ru) / [iOS](https://apps.apple.com/us/app/x-gps-tracker/id802887190)),\
...
Working with POIs requires several actions so we described them in our [guides](../../../index/places/manage-pois.md).
