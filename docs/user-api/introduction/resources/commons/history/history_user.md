...
Added more information about this API call usage in our [guide](../../../index/rules-notifications/work-with-notifications.md#all-events-of-a-user-for-a-specific-time-period).
