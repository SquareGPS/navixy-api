...
2.  **Enter the Base Request URL with the Resource and Sub-resource:**
    ...
    In our example, we will use [`user/auth`](/broken/pages/A1uF5IK31kKOG3iQqTd8#auth) and [`tracker/list`](../../user-api/backend-api/resources/tracking/tracker/index.md#list) requests. Base request URLs are:
