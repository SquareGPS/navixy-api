...
1.  **Select a Request Method:**
    ...
    ![Select request method in Postman](<../../.gitbook/assets/postman_select (1).png>)
...
2.  **Enter the Base Request URL with the Resource and Sub-resource:**
    ...
    * For US server - `https://api.us.navixy.com/v2/`
    ...
    ![Enter URL](<../../.gitbook/assets/enter-url (1).png>)
3.  **Click on the Params Button:**

    ![Enter params](<../../.gitbook/assets/postman_params (1).png>)
    ...
    ![Enter params](<../../.gitbook/assets/postman_params2 (1).png>)

    Similarly, with values and additional parameters:

    ![Enter params](<../../.gitbook/assets/postman_params3 (1).png>)

    ![Enter params](<../../.gitbook/assets/postman_params4 (1).png>)
4.  **Press Send:**

    You will see the reply, already split and highlighted for easier reading:

    ![Enter params](<../../.gitbook/assets/postman_body (1).png>)
    ...
    ![Enter params](<../../.gitbook/assets/postman_tracker_list (1).png>)

### Managing Parameters

If your request has multiple parameters listed, you can easily enable and disable them to prevent errors:

![Enter params](<../../.gitbook/assets/postman_params5 (1).gif>)
...
![Enter params](<../../.gitbook/assets/postman_response (1).gif>)
...
![Enter params](<../../.gitbook/assets/postman_apn (1).png>)
...
![Enter params](<../../.gitbook/assets/postman_curl_in (1).png>)
