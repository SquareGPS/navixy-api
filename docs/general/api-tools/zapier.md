...
4. **Dashboard Overview**\
   The dashboard displays all your Zaps. You can create, update, and manage your Zaps here.![Dashboard Zap](<../../.gitbook/assets/dashboardZap (1).png>)

### Setting Up a Trigger

1. **Select App**\
   Search for and select the Navixy app.\
   ![Search for Navixy app](<../../.gitbook/assets/searchApp (1).png>)
2.  **Configure Trigger**\
    Choose "New Tracker Event" as the trigger. Connect your account by providing a User Session Key or an API key.\
    ![New account connect](<../../.gitbook/assets/newAccountConnect (1).png>)
...
3. **Specify Trigger Details**
   * **Tracker IDs:** Find them in the admin panel or user interface.![Tracker ID admin panel](<../../.gitbook/assets/trackerIDPanel (1).png>)\
     ![Tracker ID user interface](<../../.gitbook/assets/trackerIDUI (1).png>)
...
1.  **Set Output**\
    ...
    ![Choose set output](<../../.gitbook/assets/choose-set-output (1).png>)\
    Provide:
    ...
    * Output state (enable/disable)
    ...
    ![Set output settings](<../../.gitbook/assets/set-output-settings (1).png>)
2.  **Set Outputs**

    For devices that change multiple outputs with one command.![Choose set outputs](<../../.gitbook/assets/choose-set-outputs (1).png>)\
    Provide:

    * Tracker ID
    * Output states (e.g., true,true,false for outputs 1, 2, and 3)

    ![Set outputs settings](<../../.gitbook/assets/set-outputs-settings (1).png>)
3.  **Send GPRS Command**

    For sending specific commands to a device, such as switching a digital output.![Choose send GPRS command](<../../.gitbook/assets/choose-send-gprs-command (1).png>)
    ...
    * Command (protocol-related command for the device)
    ...
    ![Set send GPRS command settings](<../../.gitbook/assets/set-send-gprs-command-settings (1).png>)
