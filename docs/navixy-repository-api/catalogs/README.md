...
<table><thead><tr><th width="175.77777099609375">Page</th><th>Description</th></tr></thead><tbody><tr><td><a href="catalog-items.md">Catalog items</a></td><td>Core queries and mutations for managing catalogs and their items, plus the <code>CatalogItem</code> interface, <code>CatalogItemMeta</code>, and shared input/output types.</td></tr><tr><td><a href="tags.md">Tags</a></td><td>Tag management for flexible, cross-entity labeling. Tags extend <code>CatalogItem</code> with an optional <code>entityTypes</code> constraint that limits which entity types a tag can be applied to.</td></tr><tr><td><a href="system.md">System catalogs</a></td><td>System-defined catalog types that cannot be modified: <code>Module</code>, <code>EntityType</code>, and <code>Country</code>.</td></tr><tr><td><a href="catalog-reference.md">Catalog reference</a></td><td>A cross-reference of the remaining (non-tag and non-system) catalog types organized by their parent entity (devices, assets, geo objects, schedules, and others).</td></tr></tbody></table>
