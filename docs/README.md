...
* [**Navixy platform API**](/broken/pages/lm0O6d7DZbclymZs5jYJ): API calls for user interface functionalities like raw device data, tracking, reports, tasks, and much more.
