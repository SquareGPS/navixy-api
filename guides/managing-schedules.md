...
To work with a schedule, you need the ID of your [organization](../api-reference/objects.md#organization). To obtain it, use the [me](../api-reference/queries.md#me) query:
...
<strong>        "version": 1,
</strong>        "title": "Weekly fleet maintenance"
      }
    }
  }
}
