...
**Arguments** [Test Link](../api-reference-old/objects.md#devicevendor/)

| Name | Type                                                   | Description |
| ---- | ------------------------------------------------------ | ----------- |
| `id` | [UUID!](../api-reference-old/objects.md#devicevendor/) |             |

**Returns:** [Node](api-reference/objects.md#devicevendor/)
...
| Name | Type                                             | Description |
| ---- | ------------------------------------------------ | ----------- |
| `id` | [UUID!](../api-reference/objects/#devicevendor/) |             |
