...
| `createdAt`     | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)               |                                                |
| `updatedAt`     | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)               |                                                |
| `deletedAt`     | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)                |                                                |
| `deletedBy`     | [Actor](../api-reference/objects.md#actor/)                             |                                                |
| `customFields`  | [JSON!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/)                       | Custom fields data                             |
...
| `assignedAt` | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) | When device was assigned |
...
| `attachedAt` | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) | When asset was added to group                                     |
| `detachedAt` | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)  | When asset was removed from group. Null means currently attached. |
| `createdAt`  | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) |                                                                   |
| `updatedAt`  | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) |                                                                   |
...
| `deletedAt`    | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)     |                                                                                                                                  |
| `deletedBy`    | [Actor](../api-reference/objects.md#actor/)                  |                                                                                                                                  |
| `customFields` | [JSON!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/)            | Custom fields including 'geojson' system field. geojson contains [GeoJSON](https://geojson.org/) geometry (Point, Polygon, etc.) |
...
| `deletedAt`    | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)   |                                                     |
| `deletedBy`    | [Actor](../api-reference/objects.md#actor/)                |                                                     |
| `customFields` | [JSON!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/)          | Custom fields including schedule\_data system field |
...
| --------------- | ----------------------------------------------------------- | -------------------------------------------------- |
| `id`            | [UUID!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)           |                                                    |
| `actorType`     | [ActorType!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#actortype/) | Type discriminator                                 |
| `createdAt`     | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)   |                                                    |
| `updatedAt`     | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)   |                                                    |
| `deletedAt`     | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)    |                                                    |
| `deletedBy`     | [Actor](../api-reference/objects.md#actor/)                 |                                                    |
...
| -------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------ |
| `id`                 | [UUID!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)           |                                                                    |
| `actorType`          | [ActorType!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#actortype/) | Always USER                                                        |
| `identityProvider`   | `String!`                                                   | Identity provider name. Examples: keycloak, auth0, okta, azure\_ad |
| `identityProviderId` | [UUID!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)           | User's unique ID in the identity provider                          |
...
| `createdAt`    | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)  |                                                                                                       |
| `updatedAt`    | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)  |                                                                                                       |
| `assignedAt`   | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)  | When user was assigned to organization                                                                |
| `deletedAt`    | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)   |                                                                                                       |
| `deletedBy`    | [Actor](../api-reference/objects.md#actor/)                |                                                                                                       |
| `customFields` | [JSON!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/)          | Membership-specific custom fields. Examples: position, department, employee\_id, access\_card\_number |
...
| --------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id`            | [UUID!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)           |                                                                                                                                                                     |
| `actorType`     | [ActorType!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#actortype/) | Always INTEGRATION                                                                                                                                                  |
...
| `assignedAt` | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) | When role was assigned                                      |
| `assignedBy` | [Actor](../api-reference/objects.md#actor/)               | Who assigned the role                                       |
| `expireDate` | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)  | Role expiration timestamp. Null means permanent assignment. |
| `createdAt`  | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) |                                                             |
| `updatedAt`  | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) |                                                             |
...
| `targetEntityId`  | [UUID](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)                               | Specific entity ID this permission applies to. Null means permission applies to all entities of the scope's type. |
| `actions`         | [\[ActionPermission!\]!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#actionpermission/) | Actions allowed by this permission                                                                                |
| `grantedAt`       | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)                      | When permission was granted                                                                                       |
...
| `targetEntityId`  | [UUID!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)                              | Specific entity the actor can access    |
| `actions`         | [\[ActionPermission!\]!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#actionpermission/) | Actions allowed on this specific entity |
...
| `order`            | `Int!`                                                           |                                                                                                          |
| `isSystem`         | `Boolean!`                                                       |                                                                                                          |
| `extra`            | [JSON!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/)                |                                                                                                          |
| `createdAt`        | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)        |                                                                                                          |
| `updatedAt`        | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)        |                                                                                                          |
| `deletedAt`        | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)         |                                                                                                          |
| `deletedBy`        | [Actor](../api-reference/objects.md#actor/)                      |                                                                                                          |
...
| `fieldType`        | [FieldType!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#fieldtype/)      | Data type determining validation and UI                                                                  |
...
| -------------- | ------------------------------------------------ | ------------------------------ |
| `isRequired`   | `Boolean!`                                       |                                |
| `defaultValue` | [Date](/broken/pages/TOdGVmQ3HHnniCOoOsfN#date/) | Default value for new entities |
...
| -------------- | -------------------------------------------------------- | ------------------------------ |
| `isRequired`   | `Boolean!`                                               |                                |
| `defaultValue` | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) | Default value for new entities |
...
| `sourceType`    | [SourceType!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#sourcetype/)         | Source type of the request                                                             |
| `sourceName`    | `String`                                                              | Source application name                                                                |
| `traceId`       | [UUID](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)                      | Distributed tracing ID. Used to correlate logs across services.                        |
| `aggregateType` | `String`                                                              | Type of entity affected. Examples: device, asset, user, organization                   |
| `aggregateId`   | [UUID](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)                      | ID of the affected entity                                                              |
| `eventType`     | [AuditEventType!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#auditeventtype/) | Type of event that occurred                                                            |
| `eventData`     | [JSON](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/)                      | Event payload with details. For updates, includes changed\_fields with old/new values. |
| `occurredAt`    | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)             | When event occurred                                                                    |
...
| `aggregateId`    | [UUID!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)                     | ID of the changed entity                         |
| `eventType`      | [AuditEventType!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#auditeventtype/) | Type of change                                   |
| `organizationId` | [UUID](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/)                      | Organization context                             |
| `payload`        | [JSON](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/)                      | Event details (changed fields, new values, etc.) |
| `occurredAt`     | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)             | When the event occurred                          |
...
| Field       | Type                                              | Description                                              |
| ----------- | ------------------------------------------------- | -------------------------------------------------------- |
| `entityId`  | [UUID!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/) | Entity this translation belongs to                       |
...
| `totalCountIsApproximate` | `Boolean`  | True if totalCount is approximate (e.g., from pg\_class.reltuples). Null or false means exact count. |
...
| `failedIds`    | [\[UUID!\]!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/) | IDs that failed to delete (permission denied, not found, etc.) |
...
| `createdAt`    | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)        |                                  |
| `updatedAt`    | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)        |                                  |
| `deletedAt`    | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/)         | Soft delete timestamp            |
| `parent`       | [CatalogItem](../api-reference/interfaces.md#catalogitem/)       |                                  |
| `children`     | [\[CatalogItem!\]!](../api-reference/interfaces.md#catalogitem/) |                                  |
...
| `fieldsSchema` | [JSON](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/)                 | JSON Schema defining structure of item.extra fields. Used for validation and UI generation. |
