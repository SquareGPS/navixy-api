...
| ----- | ------------------------------------------------- | ------------------------------------------------------------------ |
| `id`  | [UUID!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#uuid/) | Globally unique identifier with embedded entity type discriminator |
...
| Field       | Type                                                      | Description                             |
| ----------- | --------------------------------------------------------- | --------------------------------------- |
| `createdAt` | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) | When the entity was created (immutable) |
| `updatedAt` | [DateTime!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) | When the entity was last modified       |
...
| Field       | Type                                                     | Description                                       |
| ----------- | -------------------------------------------------------- | ------------------------------------------------- |
| `deletedAt` | [DateTime](/broken/pages/TOdGVmQ3HHnniCOoOsfN#datetime/) | When the entity was soft-deleted (null if active) |
...
| Field          | Type                                              | Description                                                                                                                       |
| -------------- | ------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `customFields` | [JSON!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/) | Custom fields as key-value map. Keys are field codes from CustomFieldDefinition. Values are typed according to field definitions. |
...
Base interface for all catalog items (dictionaries/reference data). Catalog items use Hierarchy support: - parent/children fields are only meaningful when is\_hierarchical=true - Hierarchical items use ltree for efficient tree queries
...
| `extra`       | [JSON!](/broken/pages/TOdGVmQ3HHnniCOoOsfN#json/)                | Additional flexible fields (icon, color, metadata). Schema may be defined by catalog.fieldsSchema.                                                                       |
