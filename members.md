...
| `assignedAt` | [DateTime](./common.md#datetime)! | The date and time when the user was assigned to this organization. |
| `customFields` | [JSON](./common.md#json)! | Membership-specific custom fields such as position and department. |
