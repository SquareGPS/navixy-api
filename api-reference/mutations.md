...
| `params` | [FieldParamsInput!](/api-reference/objects.md#fieldparamsinput/) | The type-specific parameters. Exactly one variant must be provided. |
...
| `params` | [FieldParamsInput](/api-reference/objects.md#fieldparamsinput/) | The updated parameters. Only `isRequired` and type-specific fields can be changed. |
